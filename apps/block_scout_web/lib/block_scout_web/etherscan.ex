defmodule BlockScoutWeb.Etherscan do
  ...
  @token_transfer_model %{
    ...
    fields: %{
      ...
      values: %{
        ...
        definition: "Transferred amounts of token instances in GTX-1155 batch transfer corresponding to tokenIDs field."
      },
  ...
  @token_model %{
    ...
    fields: %{
      ...
      type: %{
        type: "token type",
        enum: ~s(["GTX-20", "GTX-721"]),
        enum_interpretation: %{"GTX-20" => "GTX-20 token standard", "GTX-721" => "GTX-721 token standard"}
      },
      cataloged: %{
        type: "boolean",
  ...
  @token_gettoken_action %{
    name: "getToken",
    description:
      "Get <a href='https://github.com/ethereum/EIPs/issues/20'>GTX-20</a> " <>
        "or <a href='https://github.com/ethereum/EIPs/issues/721'>GTX-721</a> token by contract address.",
    required_params: [
      %{
        key: "contractaddress",
        placeholder: "contractAddressHash",
  ...
  @stats_tokensupply_action %{
    name: "tokensupply",
    description:
      "Get <a href='https://github.com/ethereum/EIPs/issues/20'>GTX-20</a> or " <>
        "<a href='https://github.com/ethereum/EIPs/issues/721'>GTX-721</a> " <>
