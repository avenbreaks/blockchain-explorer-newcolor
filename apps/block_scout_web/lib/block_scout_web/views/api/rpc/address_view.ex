defmodule BlockScoutWeb.API.RPC.AddressView do
  ...
  defp prepare_token_transfer(%{token_type: "GTX-721"} = token_transfer) do
    token_transfer
    |> prepare_common_token_transfer()
    |> Map.put_new(:tokenID, List.first(token_transfer.token_ids))
  end

  defp prepare_token_transfer(%{token_type: "GTX-1155", token_ids: [token_id]} = token_transfer) do
    token_transfer
    |> prepare_common_token_transfer()
    |> Map.put_new(:tokenID, token_id)
  end

  defp prepare_token_transfer(%{token_type: "GTX-1155"} = token_transfer) do
    token_transfer
    |> prepare_common_token_transfer()
  ...
  defp prepare_token_transfer(%{token_type: "GTX-20"} = token_transfer) do
    token_transfer
    |> prepare_common_token_transfer()
