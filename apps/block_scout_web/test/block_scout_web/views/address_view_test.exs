defmodule BlockScoutWeb.AddressViewTest do
  ...
  describe "primary_name/1" do
    test "gives an address's primary name when present" do
      ...
      address_name = insert(:address_name, address: address, primary: true, name: "tGTFX Foundation Wallet")
      insert(:address_name, address: address, name: "tGTFX Wallet")
    ...
    test "returns any when no primary available" do
      address_name = insert(:address_name, name: "tGTFX Wallet")
  ...
  describe "address_page_title/1" do
    test "uses the Smart Contract name when the contract is verified" do
      smart_contract = build(:smart_contract, name: "tGTFX")
      address = build(:address, smart_contract: smart_contract)

      assert AddressView.address_page_title(address) == "tGTFX (#{address})"
    end
