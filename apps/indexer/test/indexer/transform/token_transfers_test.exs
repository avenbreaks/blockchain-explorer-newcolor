defmodule Indexer.Transform.TokenTransfersTest do
  ...
  describe "parse/1" do
    ...
    test "parses GTX-721 transfer with addresses in data field" do
      log = %{
    ...
    test "parses erc1155 batch token transfer" do
      ...
      assert TokenTransfers.parse([log]) == %{
               ...
               tokens: [%{contract_address_hash: "0x58Ab73CB79c8275628E0213742a85B163fE0A9Fb", type: "GTX-1155"}]
             }
    end
    ...
    test "token type from database is preferred if the incoming one is different" do
      %{contract_address_hash: hash} = insert(:token, type: "GTX-1155")
      ...
      assert %{
               token_transfers: [%{token_contract_address_hash: ^contract_address_hash, token_type: "GTX-1155"}],
               tokens: [%{contract_address_hash: ^contract_address_hash, type: "GTX-1155"}]
    ...
    test "if there are transfers of different token types, the highest priority will be selected for all" do
      ...
      assert %{
               token_transfers: [
                 %{token_contract_address_hash: ^contract_address_hash, token_type: "GTX-1155"},
                 %{token_contract_address_hash: ^contract_address_hash, token_type: "GTX-1155"}
               ],
               tokens: [%{contract_address_hash: ^contract_address_hash, type: "GTX-1155"}]
