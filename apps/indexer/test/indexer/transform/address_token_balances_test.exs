defmodule Indexer.Transform.AddressTokenBalancesTest do
  ...
  describe "params_set/1" do
    ...
    test "does set params when the from_address_hash is the burn address for the Token GTX-721" do
      block_number = 1
    ...
    test "does not set params when the to_address_hash is the burn address for the Token GTX-721" do
      block_number = 1
