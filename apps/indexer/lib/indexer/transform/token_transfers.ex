defmodule Indexer.Transform.TokenTransfers do
  @moduledoc """
  Helper functions for transforming data for GTX-20 and GTX-721 token transfers.
  """
  ...
  @token_types_priority_order ["GTX-20", "GTX-721", "GTX-1155"]
  ...
  # GTX-721 token transfer with topics as addresses
  ...
  # GTX-721 token transfer with info in data field instead of in log topics
  defp parse_params(
         %{
           second_topic: nil,
           third_topic: nil,
