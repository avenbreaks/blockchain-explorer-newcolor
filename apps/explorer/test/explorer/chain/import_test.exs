      ...
      assert {:ok,
              %{
               ...
               Import.all(%{
                 ...
                 address_coin_balances: %{
                   params: [
                     %{address_hash: miner_hash, block_number: block_number, value: nil, token_type: "GTX-20"},
                     %{address_hash: uncle_miner_hash, block_number: block_number, value: nil, token_type: "GTX-20"}
                   ],
                   timeout: 1
                 },
                 blocks: %{
