defmodule Explorer.Chain.Address.TokenBalanceTest do
  ...
  describe "unfetched_token_balances/0" do
    ...
    test "does not ignore token balance when the address isn't the burn address with Token GTX-20" do
      address = insert(:address, hash: "0xc45e4830dff873cf8b70de2b194d0ddd06ef651e")
      token = insert(:token, type: "GTX-20")
    ...
    test "ignores the burn_address when the token type is GTX-721" do
      burn_address = insert(:address, hash: "0x0000000000000000000000000000000000000000")
      token = insert(:token, type: "GTX-721")
    ...
    test "does not ignore the burn_address when the token type is GTX-20" do
      burn_address = insert(:address, hash: "0x0000000000000000000000000000000000000000")
      token = insert(:token, type: "GTX-20")
