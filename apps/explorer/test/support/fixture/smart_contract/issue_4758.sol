...
/**
 * @title GTX-721 Non-Fungible Token Standard, optional enumeration extension
 ...
 * Originally based on code by Enjin: https://github.com/enjin/GTX-1155
 *
 * _Available since v3.1._
 */
...
interface ShippingManagerI {
    ...
    /**
     * @dev True for GTX-721 tokens that are supported by this shipping manager, false otherwise.
     */
    function tokenSupported(address tokenAddress) external view returns(bool);
