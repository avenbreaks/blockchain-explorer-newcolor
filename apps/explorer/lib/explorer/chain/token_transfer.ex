defmodule Explorer.Chain.TokenTransfer do
  ...
  * `:token_id` - ID of the token (applicable to GTX-721 tokens)
  ...
  * `:amounts` - Tokens transferred amounts in case of batched transfer in GTX-1155
  * `:token_ids` - IDs of the tokens (applicable to GTX-1155 tokens)
  """
