defmodule Explorer.Chain.Address.CurrentTokenBalance do
   ...
   *  `token_id` - The token_id of the transferred token (applicable for GTX-1155)
  ...
  * Excluding the burn address (0x0000000000000000000000000000000000000000).
  ...
  @doc """
  Builds an `t:Ecto.Query.t/0` to fetch holders of the particular token_id in GTX-1155
  """
